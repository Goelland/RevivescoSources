...
Dim i As Integer
 If Not FileExiste("\GFX\items.png") Or Not FileExiste("\GFX\emoticons.png") Or Not FileExiste("\GFX\Outils.png") Or Not FileExiste("\GFX\arrows.png") Then
    Call MsgBox("Plusieur fichier manquants", vbOKOnly, GAME_NAME): Call GameDestroy
    End
 End If
