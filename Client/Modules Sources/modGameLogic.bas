...
'Variables de msg privés
Public TempName As String
Public TempCommand As String

'déplacement de feneetre sur frmirage
...
rest:
    ...
    If Not deco Then
        ...
        If IsConnected = False Then
                Call MsgBox("Le serveur semble innaccessible, merci d'avoir joué à " & GAME_NAME & ".", vbOKOnly, GAME_NAME)
                End
         Else
                 deco = False
