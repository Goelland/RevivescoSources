...
erreur:
Call MsgBox("Une erreur de réception du serveur c'est produite(Numéros de l'erreur : " & Err.Number & " Description : " & Err.description & " Source : " & Err.Source & "." & " Ligne -> " & ligne, vbCritical, "Erreur")
Call GameDestroy
End
End Sub
